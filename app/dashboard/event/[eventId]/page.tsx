...
import { EventParticipants } from "@/components/dashboard/event/event-detials";
...
const EventDetails = async ({ params: { eventId }, searchParams }: Props) => {
        ...
        <ContentLayout title="Event">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <Link href="/dashboard/event/list">Events</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
