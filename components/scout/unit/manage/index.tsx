                                    ...
                                    <TableRow key={scout.id}>
                                        ...
                                        <TableCell className="py-3">
                                            <Badge
                                                className={cn(
                                                    ...
                                                    scout?.migrations[0]?.status === MigrationStatus.Pending && "bg-amber-500",
                                                    scout?.migrations[0]?.status === MigrationStatus.Approved && "bg-green-500",
                                                    scout?.migrations[0]?.status === MigrationStatus.Rejected && "bg-rose-500",
                                                )}
                                            >
                                        ...
                                        <TableCell className="py-3">
                                            <Badge
                                                className={cn(
                                                    "text-white bg-indigo-500",
                                                    scout?.bans[0]?.status === MigrationStatus.Pending && "bg-amber-500",
                                                    scout?.bans[0]?.status === MigrationStatus.Approved && "bg-green-500",
                                                    scout?.bans[0]?.status === MigrationStatus.Rejected && "bg-rose-500",
                                                )}
                                            >
